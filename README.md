...
[![Mentioned in Awesome Go](https://awesome.re/mentioned-badge.svg)](https://github.com/AppsFlyer/go-sundheit/)  
...
Using go modules:
```
go get github.com/AppsFlyer/go-sundheit@v0.1.1
```

Using dep:
```
dep ensure -add github.com/AppsFlyer/go-sundheit@v0.1.1
```
